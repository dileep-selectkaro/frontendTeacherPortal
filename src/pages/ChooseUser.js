...
const ChooseUser = ({ visitor }) => {
  ...
  }, [status, currentRole, response, navigate, currentUser]);
          ...
          <Grid item xs={12} sm={6} md={4}>
            <div onClick={() => navigateHandler("SuperAdmin")}>
              <StyledPaper elevation={3}>
                ...
                Login as an super administrator to access the dashboard to explore.
              </StyledPaper>
            </div>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <StyledPaper elevation={3}>
              <div onClick={() => navigateHandler("Parent")}>
                ...
                Login as a parent to view your child's detail.
              </div>
            </StyledPaper>
          </Grid>
          <Grid item xs={12} sm={6} md={4}>
