...
const Incomehead = () => {
  return (
   ...
   <div className='bg-white rounded-lg p-6 w-96  '>
       <h1 className='text-2xl font-bold'>Add Income Head</h1>
   <form className="max-w-sm ">
    
  
 
         <div className="mb-5">
       <label for="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Income Head</label>
   ...
   <div>
               <h1 className='text-2xl font-bold'>Income Head List</h1>
           </div>
