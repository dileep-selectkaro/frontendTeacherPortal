...
const Routes = () => {
  return (
   ...
   <div className='bg-white rounded-lg p-6 w-96  '>
       <h1 className='text-2xl font-bold mb-2'>Create Route
</h1>
   <form className="max-w-sm ">
         <div className="mb-5">
       <label for="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Route Title </label>
   ...
   <div>
               <h1 className='text-2xl font-bold'>Route List</h1>
           </div>
