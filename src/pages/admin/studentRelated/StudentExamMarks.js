...
const StudentExamMarks = ({ situation }) => {
    ...
    const { currentUser, userDetails, loading, classSubjectList } = useSelector((state) => state.user);
    ...
    useEffect(() => {
        if (userDetails && userDetails.sclassName && situation === "Student") {
            dispatch(getClassSubjectList(userDetails.sclassName._id));
        }
    }, [dispatch, situation, userDetails]);

    const changeHandler = (event) => {
        const selectedSubject = classSubjectList.find(
                                ...
                                <Stack spacing={3}>
                                    {
                                        ...
                                        <FormControl fullWidth>
                                            ...
                                            >
                                                {classSubjectList ?
                                                    classSubjectList.map((subject, index) => (
