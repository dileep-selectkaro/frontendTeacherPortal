...
const StudentSubjects = () => {
    ...
    const { userDetails, currentUser, loading, response, error, classSubjectList } = useSelector((state) => state.user);
    ...
    useEffect(() => {
        if (subjectMarks.length === 0) {
            dispatch(getClassSubjectList(currentUser?.sclassName?._id));
        }
